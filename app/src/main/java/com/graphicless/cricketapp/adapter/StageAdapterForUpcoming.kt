...
class StageAdapterForUpcoming(
    private val fixtures: List<StageByLeague>,
    private val lifecycleOwner: LifecycleOwner,
    private val context: Context
) : ListAdapter<StageName, StageAdapterForUpcoming.DataViewHolder>(DiffCallback) {
    ...
    class DataViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(fixture: StageByLeague, lifecycleOwner: LifecycleOwner, context: Context) {
            ...
            viewModel.getUpcomingFixturesByStageId(fixture.stageId).removeObservers(lifecycleOwner)
            viewModel.getUpcomingFixturesByStageId(fixture.stageId).distinctUntilChanged().observe(lifecycleOwner) {

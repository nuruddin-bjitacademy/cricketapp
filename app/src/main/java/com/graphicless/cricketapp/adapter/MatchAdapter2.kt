...
import com.graphicless.cricketapp.ui.fragment.MatchesByStageFragmentDirections
...
class MatchAdapter2(
    ...
    ListAdapter<FixtureAndTeam, MatchAdapter2.DataViewHolder>(DiffCallback) {
    ...
    class DataViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(fixture: FixtureAndTeam, lifecycleOwner: LifecycleOwner) {
            ...
            binding.root.setOnClickListener {
                try{
                    val direction =
                        MatchesByStageFragmentDirections.actionMatchesByStageFragmentToMatchDetailsContainerFragment(
                            fixture.fixtureId
                        )
